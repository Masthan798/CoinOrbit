...
const CoinDetailGraph = ({ coinId: propCoinId }) => {
    ...
    return (
        <div className="w-full h-auto flex flex-col gap-4 sm:gap-6 p-2 sm:p-6 sm:pb-4 bg-[#0d0e12] rounded-md border border-white/5">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 w-full">
                    <div className="flex bg-white/5 p-1 rounded-md w-full sm:w-auto">
                        <button
                            ...
                            className={`flex_1 sm:flex-initial px-4 py-1.5 rounded-md text-xs font-bold transition-all ${dataType === 'prices' ? 'bg-white text-black shadow-xl scale-102' : 'text-muted-foreground hover:text-white'}`}
                        >
                            Price
                        </button>
                        <button
            ...
            <div className={`w-full ${isMobile ? 'h-[300px]' : 'h-[500px]'} relative`} ref={chartRef}>
                {loading && (
                ...
                {error ? (
                    <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-4 bg-[#0d0e12] rounded-md border border-white/5 p-8 text-center">
                        ...
                        <button
                            ...
                            className="mt-2 px-6 py-2 bg-white/5 hover:bg-white/10 text-white text-xs font-black uppercase tracking-widest rounded-md transition-all border border-white/5"
                        >
                            Retry Connection
                        </button>
                    </div>
