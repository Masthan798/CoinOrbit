            ...
            >
                <div className="bg-card backdrop-blur-xl border border-soft rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
                    <div className="text-center mb-8 sm:mb-10">
                        ...
                        <p className="text-muted text-xs sm:text-sm">Enter your details to access your account</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                ...
                                <Link to="/forgot-password" size="sm" className="text-[10px] sm:text-xs text-muted hover:text-white transition-colors">
                                    Forgot Password?
                                </Link>
                            </div>
                            <div className="relative group">
